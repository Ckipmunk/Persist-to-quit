...
New_Game::New_Game(SDL_Renderer* r, SDL_Texture* t)
{
    ...
    plant_Place.load_Sound("C:/Users/ADMIN/source/repos/PROJECT GAME/Assets/Sound/plant_placement.wav");
    ...
    game_Music.load_Music("C:/Users/ADMIN/source/repos/PROJECT GAME/Assets/Sound/day_soundtrack.wav");
    ...
    shovel_card.loadMedia("C:/Users/ADMIN/source/repos/PROJECT GAME/Assets/Images/Background/Shovel.png");     //Loading shovel's slot texture

    shovel.ss_Rend = gRenderer;
    shovel.location = &temp_shovel;
    shovel.loadMedia("C:/Users/ADMIN/source/repos/PROJECT GAME/Assets/Images/Background/Shovel2.png");     //Loading shovel's texture

    //Loading pause game button texture
