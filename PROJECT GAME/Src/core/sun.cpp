...
void Sun::sun_setcoord(SDL_Renderer* r)
{
    ...
    sun_Texture = sun_Flow.loadMedia("C:/Users/ADMIN/source/repos/PROJECT GAME/Assets/Images/Background/Sun.png");

    point_Sound.set_Sound(gSound);
    point_Sound.load_Sound("C:/Users/ADMIN/source/repos/PROJECT GAME/Assets/Sound//Points.wav");
...
void Sun::produce_Sun()
{
    if (cur_Timer > 100)
    {
        ...
        s->ss_Texture = sun_Flow.loadMedia("C:/Users/ADMIN/source/repos/PROJECT GAME/Assets/Images/Background/Sun.png");
        s->ss_Rend = gRenderer;
        Region* r = new Region;
